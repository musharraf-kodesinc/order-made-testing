...
export const OrdersTable = () => {
  ...
  const [showInvalidSubDomain, setShowInvalidSubDomain] = useState(false);
  ...
  useEffect(() => {
    ...
    if (URLDomain !== "daraz" && URLDomain !== "foodpanda" && URLDomain !== "amazon") {
      setShowInvalidSubDomain(true);
      return;
    } else {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {showInvalidSubDomain ? (
        <p>Invalid subdomain</p>
      ) : (
        <>
          {subDomain === "daraz" || subDomain === "amazon" || subDomain === "foodpanda" ? (
